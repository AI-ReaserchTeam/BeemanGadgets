...
using BeemanGadgets.WebApi.JWT;
using DevExpress.ExpressApp.Security.Authentication.ClientServer;
using DevExpress.ExpressApp;
using DevExpress.ExpressApp.ApplicationBuilder;

namespace BeemanGadgets.WebApi;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXafWebApi(builder => {
            ...
            builder.Modules
                ...
                .AddValidation()
                .Add<BeemanGadgets.Module.BeemanGadgetsModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(BeemanGadgets.Module.BusinessObjects.BeemanAppUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(BeemanGadgets.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            builder.AddBuildStep(application => {
                application.ApplicationName = "SetupApplication.BeemanGadgets";
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "BeemanGadgets API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the BeemanGadgets.WebApi\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "BeemanGadgets WebApi v1");
            });
        }
        else {
